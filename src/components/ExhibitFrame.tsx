      ...
      <div className="relative w-full rounded-lg overflow-hidden bg-black border border-zinc-950 shadow-inner group-hover:shadow-[0_0_30px_rgba(0,0,0,0.9)] transition-all duration-700">
        ...
        <div className={`relative w-full ${aspectRatioClass} overflow-hidden h-0`}>
          <iframe
            id={`iframe-${id}`}
            loading="lazy"
            className="absolute left-0 w-full h-[calc(100%+110px)] border-none p-0 m-0 z-10 rounded-lg filter brightness-[0.85] hover:brightness-100 transition-all duration-700 shadow-2xl"
            style={{ top: "-55px" }}
            src={embedUrl}
            allowFullScreen
            allow="fullscreen"
